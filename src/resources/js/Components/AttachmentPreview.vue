                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <button
                                    @click="closeModal"
                                    class="absolute right-3 top-3 z-30 h-10 w-10 rounded-full hover:bg-black/10 transition flex items-center justify-center text-gray-100">
                                ...
                                <div class="relative group h-full">
                                    <div
                                        @click="prev"
                                        class="absolute flex items-center opacity-0 group-hover:opacity-100 text-gray-100 cursor-pointer w-12 h-full left-0 bg-black/5">
                                        <ChevronLeftIcon class="w-12"/>
                                    </div>
                                    <div
                                        @click="next"
                                        class="absolute flex items-center opacity-0 group-hover:opacity-100 text-gray-100 cursor-pointer w-12 h-full right-0 bg-black/5">
